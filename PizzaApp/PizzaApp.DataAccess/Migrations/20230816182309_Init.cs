    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "796 Main St", "Arianna", "Funk" },
                    { 2, "2600 S Rd", "Juana", "Schmeler" }
                });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "IsDelivered", "Location", "PaymentMethod", "UserId" },
                values: new object[] { 1, true, "Krispy Store", 2, 1 });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "IsDelivered", "Location", "PaymentMethod", "UserId" },
                values: new object[] { 2, false, "Glamful Store", 1, 2 });
